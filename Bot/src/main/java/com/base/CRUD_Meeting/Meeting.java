...
public class Meeting implements Registro {
    ...
    public Meeting(String name, String description, String date, String startTime, int idUser) {
        this(-1, name, description, date, startTime, idUser);
    }

    public Meeting(int id, String name, String description, String date, String startTime,int idUser) {
        this.id = id;
        this.name = name;
    ...
    public boolean insertMeeting() throws Exception {
        return arqMeetings.create(this, this.idUser);
    }
