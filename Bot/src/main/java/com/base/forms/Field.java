...
public class Field {
        ...
        public static final TextInput idEmployee = TextInput.create("idemployee", TextInputStyle.SHORT)
                .setPlaceholder("1")
                .setRequired(true)
                .setRequiredRange(1, 5)
                .build();
        public static final TextInput meetingId = TextInput.create("idmeeting", TextInputStyle.SHORT)
                .setPlaceholder("1")
                .setRequired(true)
                .setRequiredRange(1, 5)
                .build();
