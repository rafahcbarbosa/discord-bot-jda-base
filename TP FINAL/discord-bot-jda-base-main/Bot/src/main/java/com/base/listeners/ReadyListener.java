    ...
    public void onReady(ReadyEvent event){
        ...
        if (server != null){
            ...
            server.updateCommands().addCommands(
                ...
                Commands.slash(Utils.command[21], Utils.description[21])
                .addOption(OptionType.STRING,"padrao","Padrão desejado",true),
                Commands.slash(Utils.command[22], Utils.description[22])
                .addOption(OptionType.STRING,"padrao","Padrão desejado",true),
                Commands.slash(Utils.command[23], Utils.description[23]),
